    ...
    <div className="homepage">
      ...
      <div className="events"  >
        <div className="buttons">
          <div className="cima">
            <button onClick={()=>{navigate("/photographersnl/Retrato")}} className="btn retrato" > Retrato</button>
            
          </div>
          <div className="meio">
            <button onClick={()=>{navigate("/photographersnl/Casamento")}} className="btn casamento"> Casamento</button>
            <button onClick={()=>{navigate("/photographersnl/Publicidade")}} className="btn publicidade"> Publicidade</button>
          </div>
          <div className="meio2">
            <button onClick={()=>{navigate("/photographersnl/Batizado")}} className="btn batizado"> Batizado</button>
            <button onClick={()=>{navigate("/photographersnl/Evento")}} className="btn evento"> Eventos</button>

          </div>
          <div className="baixo">
            <button onClick={()=>{navigate("/photographersnl/Festa")}} className="btn festas"> Festas</button>
          </div>
      ...
      <div className="phts">
        ...
        <div className="butadere">
          <a onClick={()=>{navigate("/Registoph")}}  class="btn adere">ADERE JÁ</a>
        </div>
