...
import Topbar from "../topbarnolog/Topbar"
...
export default function Filter (){
    {
        ...
        const List = ({ list }) => (
            ...
            list.map(el =>
                <div class="header" onClick={()=>{navigate("/profileFilipeFreixo2")}} >
                    <div className="profilepic">
                        <img onClick={()=>{navigate("/profileFilipeFreixo2")}} src={el.img} alt="" className="profileimg" />
                    </div>
                    <div class="info">
                        <h2>{el.name}</h2>
                        <p>{el.description}</p>
            ...
            <div class="filterbar">
                ...
                <div class="cidades">
                    ...
                    <div class="checkconteiner">
                        <h3> Eventos : </h3>
                        <input type="checkbox" defaultChecked={check1} align="right" name="Retratos" value={check1} onChange={(e)=>setCheck1(e.target.checked)}/> Retrato&nbsp;&nbsp; <br></br>
                        <input type="checkbox" align="right" name="Casamentos" value={check2} onChange={(e)=>setCheck2(e.target.checked)}/> Casamentos&nbsp;&nbsp;<br></br>
                ...
                <div class = "filtered_content">
                    <div class="header">
                        ...
                        <select name="format" defaultValue={"Ratingmaior"} id="format" value={ordem} onChange={(e)=>setOrdem(e.target.value)} onClick={()=>{armazenar('ls_ordem',ordem);armazenar('ls_city',city1);armazenar('ls_check14',check14);armazenar('ls_check13',check13);armazenar('ls_check12',check12);armazenar('ls_check11',check11);armazenar('ls_check10',check10);armazenar('ls_check9',check9);armazenar('ls_check8',check8);armazenar('ls_check7',check7);armazenar('ls_check6',check6);armazenar('ls_check5',check5);armazenar('ls_check4',check4);armazenar('ls_check3',check3);armazenar('ls_check2',check2);armazenar('ls_check1',check1);changeFilter()}} >
...
{/*
                        <div class="header">
                            <div className="profilepic">
                                <img onClick={()=>{navigate("/profile")}} src="/assets/person/1.jpeg" alt="" className="profileimg" />
                            </div>
                            <div class="info">
                                <h2>Filipe Freixo</h2>
                                <p>Gosto de tirar fotos de casamentos, adoro o ar da natureza</p>
                                <h3>Rating: 3★     Preço:$$---$</h3>
                            </div>
                        </div>
                        <div class="header">
                            <div className="profilepic">
                            ...
                            <div class="info">
                                <h2> Rafael Mendes</h2>
                                <p>Adoro a felicidade dos meus clientes após uma bela foto.</p>
                                <h3>Rating: 4★     Preço:$$---$</h3>
                            </div>
                        ...
                        <div class="info">
                            <h2>João Ferreira</h2>
                            <p>Casamentos e Retratos é a minha praia.</p>
                            <h3>Rating: 4.2★     Preço:$$---$</h3>
                        </div>
                        </div>
